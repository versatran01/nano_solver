...
NanoSolver::NanoSolver(size_t size) : storage_(size) {}

bool NanoSolver::Update(const CostBase& function, const Scalar* x) {
...
const SolverSummary& NanoSolver::Solve(const CostBase& function,
                                       double* x_and_min) {
...
void NanoSolver::Initialize(int num_residuals, int num_parameters) {
